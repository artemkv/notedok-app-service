...
function encodePathFileSystemFriendly(path) {
...
function decodePathFileSystemFriendly(path) {
...
function getSelectionText() {
    ...
    if (window.getSelection) {
        ...
        // This code handles IE before 11
...
function countLines(text) {
    ...
    for (let i = 0, len = lines.length; i < len; i++) {
        ...
        let visualLinesCount = Math.floor(line.length / 80) + 1;
